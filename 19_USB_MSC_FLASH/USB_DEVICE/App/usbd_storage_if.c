...
#define USB_FLASH_START_ADDRESS   (  0x00000001 )    //USB Flash Address (Sector 0 in STM32L053)
...
static HAL_StatusTypeDef write_data_to_flash( uint8_t *buf, uint32_t blk_addr, uint16_t blk_len )
{
  ...
  do
  {
    ...
    EraseInitStruct.PageAddress   = 0x00000001;
    EraseInitStruct.NbPages       = 1;                    //erase 1 sector(6)
