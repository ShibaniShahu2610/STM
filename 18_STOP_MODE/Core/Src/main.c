...
int main(void) {
	 ...
	 *  WAKE-UP COUNTER = WAKE-UP TIME / WAKE-UP TIME BASE
	 *
	 *  To configure the wakeup timer to 10 sec the wakeup counter is set to 0x5A56
	 *
	 *   WAKE-UP TIME BASE =  16 / 37 kHz = 0.0004324
